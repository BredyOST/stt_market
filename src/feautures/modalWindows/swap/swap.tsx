                ...
                <div className={cls.valueBlock}>
                    <div className={cls.cover}>
                        ...
                        {sourceToken.toLowerCase() === 'usdt' && targetToken.toLowerCase() === 'stt' &&
                            <div className={cls.range}>{numberWithCommas(availableStt)} - {numberWithCommas(availableUsdt.toFixed(2))}</div>
                        }

                        {sourceToken.toLowerCase() === 'stt' &&
                        ...
                        ? <>
                            <div className={cls.infoSwap}>
                                ...
                                {targetToken.toLowerCase() === 'usdt'
                                    ? <div>1 STT =  {rate ? (parseFloat(rate?.toString().replace(',', '.')) * (1 - (fee / 100))).toFixed(6) : 0.000} USDT</div>
                                    : <>
                                        {targetToken.toLowerCase() === 'stt'
                                            ? <span>1 stt = {correctRate && !isNaN(correctRate) ? correctRate.toFixed(8) : 0.000} USDT</span>
