                    ...
                    <div className={cls.stt_modal_header}>
                        {!withoutWallet && telegramUsername !== ''
                            ? <>
                                ...
                                <CustomButton onClick={closeModalNotifications} classnameWrapper={cls.wrapper_btn}
                                              classNameBtn={cls.cover_btn} type='button'>
                                    <SvgClose className={cls.close_svg}/>
                                </CustomButton>
                                <div className={cls.cover_head}>
                                    <div> Address ****{account?.substr(account?.length - 4)} linked to<br/>Telegram
                                        account
                                    </div>
                                </div>
                                ...
                                <CustomButton onClick={changeTelegram} classNameBtn={cls.btn}
                                              type='button'>Disable
                                </CustomButton>
                            </>
                            : <>
                                ...
                                <div className={cls.linkCover}>
                                    <a href={"https://t.me/stt_info_bot"} target="_blank"
                                       rel="noopener noreferrer">@stt_info_bot</a>
                                </div>
                                ...
                                <CustomButton onClick={() => checkTelegram(true)} classNameBtn={cls.btn}
                                              type='button'> I Sent
                                </CustomButton>
