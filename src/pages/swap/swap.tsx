import './swap.css';
import swIcon from '../../assets/swap-icon.png';
        ...
        <React.Fragment>
            <div className={'main-block eth-card'}>
                ...
                <div className={'swap_block-to'}>
                    ...
                    <div onClick={props.withoutWallet ? () => setWwModal(true) : undefined}>
                        <Select
                            ...
                            {!props.withoutWallet ? (
                                <React.Fragment>
                                    ...
                                    {targetToken === 'usdt' ? (
                                        <span>
                                            1 STT ={' '}
                                            {rate ? (parseFloat(rate.toString().replace(',', '.')) * (1 - fee / 100)).toFixed(6) : 0.0} USDT
                                        </span>
                                    ) : (
                                        <React.Fragment>
                                            {targetToken === 'stt' ? (
