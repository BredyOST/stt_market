...
function History(props) {
    ...
    const showModal:ForFunc<any, void> = (item) => {
        ...
        dispatch(openModal({modalName: modal as keyof IModalWindowStatesSchema}))
    }
                            ...
                            fullHistory?.map((item: any) => {
                                ...
                                return (
                                    <SwiperSlide style={{ width: "fit-content" }} key={item?.hash}>
                                        <CustomButton classnameWrapper={cls.cover_transaction} classNameBtn={cls.btn} onClick={() => showModal(item)} type='button'>
                                            <div className={cls.cover_in_btn}>
                                                ...
                                                <div className={`${cls.salary} ${cls[background]}`}>{item?.modifier} {item?.amount}</div>
                                            </div>
                                        </CustomButton>
                                    </SwiperSlide>
                                );
