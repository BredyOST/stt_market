...
//   const {changeStateLogIn, addNumberWallet} = formsAddProfileActions; // Доступ ко всему состоянию
//
...
//                   <Header withoutWallet={withoutWallet} account={account} />
//                   <button onClick={showHeader} className={'btnShowHeader'}><SvgArrow className='svgArrow'/></button>
//                 </Col>
//               </Row>
