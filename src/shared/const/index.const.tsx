...
import cls from '../../widgets/profileInfo/profile.module.scss';
...
/** для карточек слайдеров неавторизованных польхователей*/
export const CARDS_FOR_SLIDERS_NOT_AUTH_USERS: ICardsForSliders[] = [
    {
        id: 1,
        title: 'AI-agents',
        description: 'настройте своего AI-агента и для динамичного продвижения аккаунта',
        link: `/img/id_1_card.jpg`,
    },
    ...
    { id: 3, title: 'Art', description: 'покажите свое творчество огромной аудитории', link: `/img/id_3_card.jpg` },
    {
        id: 4,
        title: 'MLM',
        description: 'стройте свои mlm  компании с  автономными мега-структурами на блокчейне',
        link: `/img/id_4_card.jpg`,
    },
...
/**  гифки на главное старице для неавторизованных пользователей*/
export const PICTURES_WHEN_USER_NOT_AUTH: IPicturesNotAuth[] = [
    { id: 1, link: '/img/noAuth.png', description: 'man in the flowers' },
    { id: 2, link: '/img/flower.png', description: 'flower' },
];

/** для отбражения полей пользователя в шапке магазина*/
export const INFO_USER_HEADER: IInfoUserInHeader[] = [
    { id: 1, label: labelProfileInfo.donations, svg: <SvgCash className={`${cls.svgInfo} ${cls.cash}`} /> },
    { id: 2, label: labelProfileInfo.favourites, svg: <SvgFavorites className={`${cls.svgInfo} ${cls.star}`} /> },
    { id: 3, label: labelProfileInfo.subscribers, svg: <SvgSubscribers className={`${cls.svgInfo} ${cls.subsribers}`} /> },
];

/** для отбражения полей пользователя в шапке магазина*/
export const INFO_USER_SEND_TOKENS: IInfoUserInHeader[] = [
    { id: 1, label: labelProfileInfo.donations, svg: <SvgCash className={`${cls.svg_info} ${cls.cash_modal}`} /> },
    { id: 2, label: labelProfileInfo.favourites, svg: <SvgFavorites className={`${cls.svg_info} ${cls.star_modal}`} /> },
    { id: 3, label: labelProfileInfo.subscribers, svg: <SvgSubscribers className={`${cls.svg_info} ${cls.subsribers_modal}`} /> },
];

/** для тестового периода, далее будет расчитываться автоматически */
export const TABS_OPTIONS: IBlockMlm[] = [
    { id: 1, percent: 0.05 },
    { id: 2, percent: 0.55 },
    { id: 3, percent: 0.25 },
    { id: 4, percent: 0.1 },
...
export const NEED_AUTH: string = 'The action is available for authorized users';
...
/** Для swap компонента*/
export const FROM_OPTIONS: SwapOptionsFrom[] = [
    { value: 'stt', label: 'STT', icon: '/img/stt-logo.svg' },
    { value: 'usdt', label: 'USDT', icon: '/img/tether.svg' },
];
export const FORM_LIST = ['stt', 'usdt'];
export const TO_OPTIONS: SwapOptionsTo = {
    stt: [
        { value: 'usdt', label: 'USDT', icon: '/img/tether.svg' },
...
export const ICONS_TOKENS = {
    stt: '/img/stt-logo.svg',
    usdt: '/img/tether.svg',
    usdc: '/img/usdc.svg',
    weth: '/img/weth.webp',
    arb: '/img/arb.svg',
