        ...
        <div>
            <div className={cls.wrapper}>
                <div className={cls.coverSubTitle}>
                    <h3 className={cls.title}>{t('WantToAddProfile')}</h3>
                </div>
                <div>
                    <CustomButton classNameBtn={cls.buttonModal} type='button' onClick={changeStateModalWindow}>
                        {!userInfo?.profile?.id ? t('addProfile') : t('editProfile')}
                    </CustomButton>
                </div>
            </div>
