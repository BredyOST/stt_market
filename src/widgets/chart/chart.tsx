...
//
// < div
// className = {visibility ? cls.hidden : cls.showed} >
//     < div
// className = {`${indicator == 'noAuth' ? cls.wrapper_transparent : cls.wrapper} ${visibility ? cls.wrapper_big : cls.wrapper_compact}`
// }>
// <
// div
// className = {`${visibility ? cls.block_chart_label : cls.block_chart_label_compact}`
// }>
// {
//     visibility && <div className={cls.main_block__header_number}>{firstTick} STT</div>
// }
// <div
//     className={`${visibility ? cls.main_block__header_number : cls.main_block__header_number_compact}`}>{chartEnd} STT</div>
// </div>
//
// <div className={`${visibility ? cls.chart_data_delta : cls.chart_data_delta_compact}`}>+ {chartDelta}%</div>
// <ResponsiveContainer className={cls.cover_chart_block} height="100%" width="100%"
//
// >
//     <LineChart data={shownDataChart}
