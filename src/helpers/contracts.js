...
export const usdtContractAddress = '0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9';
export const exchangeContractAbi = [
    ...
    {
        inputs: [
            { internalType: 'uint256', name: '_minUSDTEmission', type: 'uint256' },
            { internalType: 'uint256', name: '_minSTT', type: 'uint256' },
        ],
        name: 'setMin',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    },
    {
        ...
        name: 'setStatusAdditionEmission',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
        inputs: [],
        name: 'statusAdditionEmission',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
        inputs: [{ internalType: 'uint256', name: '_amountSTT', type: 'uint256' }],
        name: 'swap',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
...
export const exchangeContractAddress = '0x88af31e521fca0ed362582aa231189849f1e3b2e';
export const newExchangeAbi = [
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: 'address', name: 'previousOwner', type: 'address' },
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'contract IERC20', name: '_addressContract', type: 'address' },
        ],
        name: 'setTokenERC20',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_amountSST', type: 'uint256' },
        ],
        name: 'swap',
        outputs: [],
        stateMutability: 'nonpayable',
...
export const newExchangeAddress = '0xf5B4001A2aEe3821419576B1E9D96d160c69B901';
export const reverseUsdtSttAddress = '0x11F2754320C961f4fFbC0174C8B4587903F816Dc';
export const reverseUsdtSttAbi = [
    {
        inputs: [
            { internalType: 'address', name: 'ownerAddress', type: 'address' },
            { internalType: 'address', name: 'sttExchangeAddress', type: 'address' },
            { internalType: 'address', name: 'usdtTokenAddress', type: 'address' },
            { internalType: 'address', name: 'sttTokenAddress', type: 'address' },
            { internalType: 'uint256', name: '_factor', type: 'uint256' },
            { internalType: 'uint256', name: '_minUsdt', type: 'uint256' },
        ],
        stateMutability: 'nonpayable',
        type: 'constructor',
    },
    ...
    {
        inputs: [],
        name: 'burnSttAutomationContractAddress',
        outputs: [{ internalType: 'address', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        inputs: [],
        name: 'depositUsdtAutomationContractAddress',
        outputs: [{ internalType: 'address', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        inputs: [{ internalType: 'address', name: '_burnSttAutomationContractAddress', type: 'address' }],
        name: 'setBurnSttAutomationContractAddress',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
        inputs: [{ internalType: 'address', name: '_depositUsdtAutomationContractAddress', type: 'address' }],
        name: 'setDepositUsdtAutomationContractAddress',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    ...
    {
        inputs: [{ internalType: 'uint256', name: '_minUsdt', type: 'uint256' }],
        name: 'setMinUsdt',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
        inputs: [],
        name: 'sttExchange',
        outputs: [{ internalType: 'contract ISTTExchange', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
...
export const arbitrumTestnet = [
    {
        chainId: '0x66eee',
        chainName: 'Arbitrum One Sepolia Testnet',
        nativeCurrency: {
            name: 'ETH',
            symbol: 'ETH',
            decimals: 18,
...
export const arbitrumCurrent = arbitrumMainnet;
